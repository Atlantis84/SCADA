...
set_target_properties(rabbitmq::rabbitmq-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librabbitmq.4.lib"
  )

list(APPEND _cmake_import_check_targets rabbitmq::rabbitmq-static )
list(APPEND _cmake_import_check_files_for_rabbitmq::rabbitmq-static "${_IMPORT_PREFIX}/lib/librabbitmq.4.lib" )
