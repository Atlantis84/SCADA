...
foreach(_cmake_expected_target IN ITEMS rabbitmq::rabbitmq rabbitmq::rabbitmq-static)
...
set_target_properties(rabbitmq::rabbitmq-static PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:OpenSSL::SSL>;\$<LINK_ONLY:ws2_32>"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/rabbitmq-targets-*.cmake")
