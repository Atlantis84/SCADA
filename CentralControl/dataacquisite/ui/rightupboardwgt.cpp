...
#include <QGroupBox>
#include <QLabel>
RightUpBoardWgt* RightUpBoardWgt::m_pRightUpBoardWgt = nullptr;
RightUpBoardWgt::RightUpBoardWgt(QWidget *parent) : QWidget(parent)
{
...
//    m_pListWgt->addItem(u8"安全门报警");
    ...
    QGroupBox* grpBox1 = new QGroupBox(u8"设备状态");
    grpBox1->setAlignment(Qt::AlignHCenter);
...
void RightUpBoardWgt::slot_right_update_ui_info_state(int status)
{
    if(status == 1)
...
void RightUpBoardWgt::slot_right_update_ui_info_warnings(QList<QString> lstInfo)
{
